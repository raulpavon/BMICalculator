...
struct CalculatorManager {
    ...
    mutating func calculateBMI(weight: Float, height: Float) {
        ...
        if bmiValue < 18.5 {
            ...
            bmi = BMI(value: bmiValue, advise: "Eat less pies!", color: #colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1))
            //bmi = BMI(value: bmiValue, advise: "Eat more pies!", color: .green)
        } else {
            bmi = BMI(value: bmiValue, advise: "Fit as a fiddle!", color: #colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1))
